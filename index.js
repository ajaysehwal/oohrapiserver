...
app.get(
  "/schoolstudent/:school_id/:gender",
  controllers.getstudent_data_by_gender
);

app.get(
  "/studentsdata/:classes/:section/:school_id",
  controllers.getstudent_data_by_class_section
);
app.get(
...
app.post(
  ...
  controllers.poststudentdata_excel
);
app.post(
  "/apiteacher",
...
app.get(
  "/schoolteacher/:school_id/:gender",
  controllers.getteacherdatabyadmin_by_gender
);

app.get(
  "/teacherdata/:teacher_id/:admin_id",
  controllers.getteacherdatabyteacher_id
);
...
app.get(
  "/studentsection/:classes/:user_id",
  controllers.class_section_get_class
);
...
app.get("/teacher/images", (req, res) => {
  ...
  const imageUrls = imagePaths.map(
    (imagePath) => `${serverDomain}/images/teachersfiles/${imagePath}`
  );
  res.json(imageUrls);
});
...
app.get(
  "/schooltimetablebyteacher/:teacher_id/:admin_id",
  controllers.schooltimetable_get_teacher
);
app.get(
  "/schooltimetablebyclasses/:classes/:section/:school_id",
  controllers.schooltimetable_get_class_section
);
...
app.get(
  "/studentfees/:school_id/:student_id",
  controllers.managestudentfee_get_by_school_id
);
app.get(
  "/schoolstudentfees/:student_id/:school_id/:month/:year",
  controllers.managestudentfee_get_by_school_id_student_id
);
...
app.get(
  "/schoolannouncement/:school_id/:id",
  controllers.school_announcement_id
);
app.get(
  "/schoolsection/:section/:classes/:school_id",
  controllers.school_section_dublicate
);
app.delete("/schoolsection/:id", controllers.section_delete);
app.get(
  "/schoolsubjectscan/:subject/:school_id/:classes",
  controllers.school_subject_dublicate
);
app.get(
  "/schoolhousescan/:name/:school_id/",
  controllers.studenthouse_scan_dublicate
);
...
app.get(
  "/studentfee/:school_id/:classes",
  controllers.managestudentfee_get_by_school_id_class
);
app.get(
  "/studentsubjectsbyclass/:classes",
  controllers.schoolsubject_get_id_class
);
app.put("/studentupdated/:id", controllers.update_student_data);
app.put(
  "/studentupdateddocs/:id",
  studentupload.fields([{ name: "file1", maxCount: 1 }]),
  controllers.studentdocupdate
);
app.put(
  "/studentupdatedimage/:id",
  studentupload.fields([{ name: "file2", maxCount: 1 }]),
...
app.put(
  "/teacherdoc/:id",
  teacherupload.fields([{ name: "file1", maxCount: 1 }]),
  controllers.teacherdocupdate
);
app.put(
  "/teacherimg/:id",
  teacherupload.fields([{ name: "file2", maxCount: 1 }]),
  controllers.teacherimgupdate
);
app.put(
  "/nonteacherdoc/:id",
  nonteacherupload.fields([{ name: "file1", maxCount: 1 }]),
  controllers.nonteacherdocupdate
);
app.put(
  "/nonteacherimg/:id",
  nonteacherupload.fields([{ name: "file2", maxCount: 1 }]),
  controllers.nonteacherimgupdate
);
app.get("/feesapi/:id", controllers.feedetails);
app.put("/feeapi/:id/:student_id", controllers.PaymentUpdatefeedetails);
app.post("/otherfeeapi/:school_id/:student_id", controllers.OtherExtraFees);
app.get(
  "/paymenthistory_api/:school_id/:student_id",
  controllers.paymenthistory
);
app.get("/allpaymenthistory/:school_id", controllers.Allpaymenthistory);
app.get(
  "/paymentamount/:school_id/:student_id",
  controllers.paymenthistorybyamount
);
app.post("/schoolexams/:school_id", controllers.SchoolExam_Post);
app.get("/schoolexams/:school_id", controllers.SchoolExam_Get);
const StudentMarksExcel = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "upload/StudentMarksFiles/");
  },
  filename: function (req, file, cb) {
    return cb(
      null,
...
const StudentMarksUpload = multer({ storage: StudentMarksExcel });
